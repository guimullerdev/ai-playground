...
export async function createPerfAgent() {
  return new RequirementAgent({
    ...
    tools: [new ThinkTool()],
    instructions:
      `You are a performance engineer. Review the submitted code for algorithmic complexity issues, inefficient loops, unnecessary re-computation, and N+1 query patterns. 
